...
namespace Constants_Common
{
    ...
    inline constexpr const char* messageFooter = " (setupLastMessage: "; // Footer for the message to be displayed on the screen
    inline constexpr const char* messageFooterEnd = ")"; // Footer end for the message to be displayed on the screen
...
namespace Constants_DelayTimes
{
    ...
    inline constexpr uint32_t MAIN_LOOP = 1000; // Delay time in milliseconds for the loop
    ...
    inline constexpr uint32_t BME280_LOOP = 300; // Delay time in milliseconds for BME280 initialization
...
namespace Global_Variables
{
    ...
    inline void* bme280AccessInstanceHolder = nullptr; // BME280 access instance for BME280 handling
